...
public class CobolParser implements PsiParser, LightPsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    create_token_set_(ELEMENTARY_ITEM_DECL_, GROUP_ITEM_DECL_, ITEM_DECL_),
  };
  ...
  /* ********************************************************** */
  // item_level_decl_ item_name_decl_ item_type_decl_ [item_value_decl_] DOT
  public static boolean elementary_item_decl_(PsiBuilder b, int l) {
    ...
    r = r && elementary_item_decl__3(b, l + 1);
  ...
  // [item_value_decl_]
  private static boolean elementary_item_decl__3(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "elementary_item_decl__3")) return false;
  ...
  /* ********************************************************** */
  // item_level_decl_ item_name_decl_ DOT
  ...
  /* ********************************************************** */
  // group_item_decl_|elementary_item_decl_
  public static boolean item_decl_(PsiBuilder b, int l) {
    if (!recursion_guard_(b, l, "item_decl_")) return false;
    if (!nextTokenIs(b, INTEGER)) return false;
    boolean r;
    Marker m = enter_section_(b, l, _COLLAPSE_, ITEM_DECL_, null);
    r = group_item_decl_(b, l + 1);
    if (!r) r = elementary_item_decl_(b, l + 1);
    exit_section_(b, l, m, r, false, null);
    return r;
  }
  ...
  /* ********************************************************** */
  // STRING|number_literal_
  static boolean literal_(PsiBuilder b, int l) {
