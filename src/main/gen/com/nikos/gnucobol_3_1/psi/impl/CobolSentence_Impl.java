...
public class CobolSentence_Impl extends ASTWrapperPsiElement implements CobolSentence_ {

  public CobolSentence_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitSentence_(this);
  }
