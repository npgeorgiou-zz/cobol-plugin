...
public class CobolMultiply_Impl extends ASTWrapperPsiElement implements CobolMultiply_ {

  public CobolMultiply_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitMultiply_(this);
  }
