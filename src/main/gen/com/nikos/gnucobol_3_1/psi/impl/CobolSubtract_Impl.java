...
public class CobolSubtract_Impl extends ASTWrapperPsiElement implements CobolSubtract_ {

  public CobolSubtract_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitSubtract_(this);
  }
