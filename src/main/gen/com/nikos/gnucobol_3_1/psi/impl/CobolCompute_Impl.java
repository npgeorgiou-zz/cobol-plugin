...
public class CobolCompute_Impl extends ASTWrapperPsiElement implements CobolCompute_ {

  public CobolCompute_Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull CobolVisitor visitor) {
    visitor.visitCompute_(this);
  }
